...
В дальнейшем я планирую расширять функционал и кол-во полей.

* В файле apiclasses.py описаны классы для работы с API hh.ru и superjob.ru
* В файле Vacancy.py описан класс создающий сущность для работы с полями (вакансия хранится в словаре)
* В файле json_funcs_class.py описаны разные классы
* В файле utils.py описаны функции
...
1) фильтрация по минимальной зарплате
2) фильтрация по поисковому запросу в полях Наименование и Описание
3) Вывод топ N вакансий (N вводится с клавиатуры пользователем)
